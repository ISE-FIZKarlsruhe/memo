 ...
 * [memo.yml](memo.yml)
     * Determines how your purl.obolibrary.org/obo/memo/ redirects will be handled
     ...
     * Paste in the contents of [memo.yml](memo.yml)
 ...
 * [memo.md](memo.md)
     ...
     * Paste in the contents of [memo.md](memo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
